...
void main() {
  Future<void> runInteraction(
    ...
    for (var i = 0; i < aliceCiphertextMessages.length / 2; i++) {
      var receivedPlaintext = await bobCipher.decryptFromSignal(
    ...
    for (var i = 0; i < bobCiphertextMessages.length / 2; i++) {
      var receivedPlaintext = await aliceCipher.decryptFromSignal(
